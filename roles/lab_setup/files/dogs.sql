...
CREATE TABLE `puppies` (
  ...
  `breed` varchar(48) DEFAULT NULL,
  `colour` varchar(48) DEFAULT NULL
...
INSERT INTO `puppies` VALUES ('fido','labrador','brown'),('spot','dalmation','black'),('pip','terrier','grey');
...
-- Dump completed on 2017-08-21 15:02:25
